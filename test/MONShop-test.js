...
const tokenJSON = require('../artifacts/contracts/Erc.sol/MONToken.json');


describe("MONShop", function() {
  let owner;
  let buyer;
  let shop;
  let erc20;
  ...
  beforeEach(async function() {
    ...
    const MONShop = await ethers.getContractFactory("MONShop", owner);
    shop = await MONShop.deploy();
    await shop.deployed();
